...
const shootingUpAnim: SpriteAnim = {frames: [{row: 34, col: 1}, {row: 34, col: 2}, {row: 34, col: 3}, {row: 34, col: 3}], speed: 0.5};
const shootingLeftAnim: SpriteAnim = {frames: [{row: 35, col: 1}, {row: 35, col: 2}, {row: 35, col: 3}, {row: 35, col: 3}], speed: 0.5};
const shootingDownAnim: SpriteAnim = {frames: [{row: 36, col: 2}, {row: 36, col: 3}, {row: 36, col: 4}, {row: 36, col: 4}], speed: 0.5};
