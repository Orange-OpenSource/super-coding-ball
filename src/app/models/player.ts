...
const greetingAnim: SpriteAnim = {frames: [{row: 24, col: 0}, {row: 2, col: 4}, {row: 2, col: 5}, {row: 3, col: 5}, {row: 0, col: 5}, {row: 1, col: 5}, {row: 2, col: 5}, {row: 2, col: 4}], speed: 0.2};
...
const pushedUpAnim: SpriteAnim = {frames: buildFrames(Dir.Right, 0, 4, 2), speed: 0.2};
const pushedLeftAnim: SpriteAnim = {frames: buildFrames(Dir.Right, 1, 4, 2), speed: 0.2};
const pushedDownAnim: SpriteAnim = {frames: buildFrames(Dir.Right, 2, 4, 2), speed: 0.2};
const pushedRightAnim: SpriteAnim = {frames: buildFrames(Dir.Right, 3, 4, 2), speed: 0.2};
